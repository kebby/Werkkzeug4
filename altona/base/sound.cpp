...
sBool sSetSoundHandler(sInt freq,sSoundHandler handler,sInt latency,sInt flags)
{
  ...
  WAVEFORMATEXTENSIBLE sformat = { { WAVE_FORMAT_PCM,2,(DWORD)freq,(DWORD)(freq*4,4),16,0 }, {0}, {3}, {0} };
  ...
  sformat.Format.wBitsPerSample = 16;
...
sBool sSetSoundInHandler(sInt freq,sSoundHandler handler,sInt latency)
{
  ...
  static WAVEFORMATEX wfx = { WAVE_FORMAT_PCM,2,(DWORD)freq,(DWORD)(freq*4),4,16,0};
